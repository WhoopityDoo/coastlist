...
/*
╔══════════════════════════════════════════════════════════════╗
║  COASTLIST.COM — Full Experience, No Outbound Links          ║
║                                                              ║
║  PUBLIC:  coastlist.com       → Browse waterfront properties ║
║  ADMIN:   coastlist.com?admin=true → Add/edit properties     ║
║                                                              ║
║  Properties stay on CoastList. No Zillow redirects.          ║
║  Ad-ready layout for future monetization.                    ║
╚══════════════════════════════════════════════════════════════╝
*/
...
const C = {
  ...
  g100:"#F8F9FA",g200:"#E9ECEF",g300:"#DEE2E6",g400:"#CED4DA",
  g500:"#ADB5BD",g600:"#6C757D",g700:"#495057",g800:"#343A40",
  green:"#2D9F6F",greenBg:"#E6F7EF",redBg:"#FEF0EE",yellowBg:"#FFF8E7",
};
...
const COUNTIES_BY_STATE={
  "Florida":["Miami-Dade","Palm Beach","Monroe","Collier","Sarasota","Pinellas","Volusia","St. Johns","Brevard","Lee","Martin","Duval","Bay","Walton"],
  "California":["Los Angeles","San Diego","Orange","Santa Barbara","Monterey","Marin","San Francisco","Mendocino","Sonoma"],
  ...
  "New Jersey":["Cape May","Ocean","Monmouth","Atlantic"],
  "Connecticut":["Fairfield","New London","Middlesex","New Haven"],
  "Virginia":["Virginia Beach","Accomack","Northampton","Lancaster"],
  "Maryland":["Worcester","Talbot","Dorchester","Somerset","Anne Arundel"],
  "Georgia":["Chatham","Glynn","Camden","McIntosh"],
  "New York":["Suffolk","Nassau","Westchester","Queens"],
  "Rhode Island":["Washington","Newport","Bristol"],
};
...
const DEMO=[
  {id:"DEMO-001",address:"1247 Oceanview Dr",city:"Palm Beach",state:"Florida",county:"Palm Beach",price:4250000,beds:5,baths:4,sqft:4800,lotAcres:0.82,waterType:"Ocean",waterFrontage:180,yearBuilt:2018,daysOnMarket:12,description:"Stunning direct oceanfront estate with 180 feet of private beach frontage. Seawall and private dock with deep water access. This magnificent property offers resort-style living with a heated infinity pool overlooking the Atlantic, chef's kitchen with top-of-the-line appliances, and a primary suite with panoramic ocean views. The lush tropical landscaping provides privacy while the elevated terrace is perfect for watching sunrise over the water. Riparian rights included with direct beach access from the property.",image:"https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&h=500&fit=crop",images:["https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&h=500&fit=crop","https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=500&fit=crop","https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=500&fit=crop"],features:["Private Dock","Seawall","Infinity Pool","Deep Water Access","Beach Frontage","Smart Home"],featured:true,isDemo:true},
  {id:"DEMO-002",address:"892 Harbor Ln",city:"Beaufort",state:"South Carolina",county:"Beaufort",price:1850000,beds:4,baths:3,sqft:3200,lotAcres:1.1,waterType:"River",waterFrontage:220,yearBuilt:2005,daysOnMarket:28,description:"Elegant riverfront home on the Beaufort River with 220 feet of water frontage and private deep water dock with boat lift. The open floor plan takes full advantage of the sweeping river views with walls of windows in every main living space. A screened porch runs the entire width of the home, perfect for enjoying the coastal breezes. The dock includes two boat slips and a covered fish cleaning station.",image:"https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&h=500&fit=crop",images:["https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&h=500&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=500&fit=crop"],features:["Deep Water Dock","Boat Lift","Screened Porch","River Views","Bulkhead"],featured:false,isDemo:true},
  {id:"DEMO-003",address:"3301 Coastal Blvd",city:"Monterey",state:"California",county:"Monterey",price:5750000,beds:5,baths:5,sqft:5400,lotAcres:1.3,waterType:"Ocean",waterFrontage:95,yearBuilt:2020,daysOnMarket:5,description:"Modern architectural masterpiece perched on the bluffs with direct ocean frontage. Property line extends to the coastal bluff edge with a private staircase to the beach below. Floor-to-ceiling windows frame the Pacific in every room. The cantilevered deck appears to float above the waves.",image:"https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=500&fit=crop",images:["https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=500&fit=crop","https://images.unsplash.com/photo-1602343168117-bb8ffe3e2e9f?w=800&h=500&fit=crop"],features:["Bluff Top","Beach Stairs","Modern Design","Wine Cellar","Ocean Frontage"],featured:true,isDemo:true},
  {id:"DEMO-004",address:"78 Pondview Circle",city:"Nantucket",state:"Massachusetts",county:"Nantucket",price:3200000,beds:3,baths:2,sqft:2100,lotAcres:0.45,waterType:"Pond",waterFrontage:120,yearBuilt:1985,daysOnMarket:45,description:"Classic Nantucket cottage on Hummock Pond with 120 feet of pond frontage. Private dock perfect for kayaks and canoes. Beautifully renovated with original character preserved. The property includes deeded water access and a dock permit.",image:"https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=500&fit=crop",images:["https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=500&fit=crop"],features:["Pond Frontage","Private Dock","Renovated","Nantucket Style"],featured:false,isDemo:true},
  {id:"DEMO-005",address:"2200 River Bend Rd",city:"Charleston",state:"South Carolina",county:"Charleston",price:2800000,beds:5,baths:4,sqft:4100,lotAcres:2.1,waterType:"River",waterFrontage:340,yearBuilt:2015,daysOnMarket:18,description:"Spectacular estate on the Ashley River with an extraordinary 340 feet of river frontage. Deep water dock with two boat slips, boat lift, and floating kayak dock. The seawall protects the entire waterfront property line while the expansive lawn sweeps down to the water's edge.",image:"https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=500&fit=crop",images:["https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=500&fit=crop","https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&h=500&fit=crop"],features:["340ft Frontage","Deep Water","Boat Lift","Seawall","Floating Dock","2+ Acres"],featured:true,isDemo:true},
  {id:"DEMO-006",address:"415 Lakeside Dr",city:"Traverse City",state:"Michigan",county:"Grand Traverse",price:1250000,beds:4,baths:3,sqft:2600,lotAcres:0.55,waterType:"Lake",waterFrontage:100,yearBuilt:2010,daysOnMarket:33,description:"Beautifully updated lakefront home with 100 feet of sandy beach frontage on Lake Michigan. Open concept living with vaulted ceilings and a wall of windows overlooking the lake. The stone patio leads directly to your private sandy beach.",image:"https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&h=500&fit=crop",images:["https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&h=500&fit=crop"],features:["Sandy Beach","Lake Michigan","Vaulted Ceilings","Stone Patio"],featured:false,isDemo:true},
];

const fmtP=(p)=>`$${p.toLocaleString()}`;
const fmtPs=(p)=>p>=1e6?`$${(p/1e6).toFixed(p%1e6===0?0:1)}M`:`$${(p/1e3).toFixed(0)}K`;
...
function Card({p,onSelect,favs,toggleFav}){
  ...
  return(<div onClick={()=>onSelect(p)} style={{background:C.white,borderRadius:13,overflow:"hidden",boxShadow:"0 2px 14px rgba(27,43,75,0.07)",cursor:"pointer",transition:"all 0.3s",border:`1px solid ${C.g200}`}}
    ...
    <div style={{position:"relative",height:190,background:C.g200,overflow:"hidden"}}>
      ...
      {p.featured&&<div style={{position:"absolute",bottom:9,left:9,background:"rgba(212,168,83,0.95)",color:C.white,padding:"2px 7px",borderRadius:4,fontSize:9,fontWeight:700,display:"flex",alignItems:"center",gap:3,letterSpacing:"0.05em"}}>{I.star} FEATURED</div>}
    </div>
    <div style={{padding:"13px 15px",display:"flex",flexDirection:"column",gap:5}}>
      ...
      <div style={{display:"flex",gap:12,fontSize:12,color:C.g600}}>
        <span style={{display:"flex",alignItems:"center",gap:3}}>{I.bed} {p.beds}</span>
        <span style={{display:"flex",alignItems:"center",gap:3}}>{I.bath} {p.baths}</span>
        <span style={{display:"flex",alignItems:"center",gap:3}}>{I.area} {p.sqft?.toLocaleString()}</span>
      </div>
...
function PropertyPage({p,onBack,favs,toggleFav,allProperties,onSelect}){
  ...
  const wc=WC[p.waterType]||WC.Ocean;
  ...
  return(
    <div style={{minHeight:"100vh",background:C.sandLight}}>
      {/* Top bar */}
      ...
      <div style={{maxWidth:1000,margin:"0 auto",padding:"24px 24px 60px"}}>
        ...
        <div style={{position:"relative",borderRadius:16,overflow:"hidden",height:"clamp(300px, 50vw, 480px)",background:C.g200,marginBottom:24}}>
          <img src={imgs[imgIdx]} alt={p.address} style={{width:"100%",height:"100%",objectFit:"cover",transition:"opacity 0.3s"}}/>
          {imgs.length>1&&<>
          ...
          {p.featured&&<div style={{position:"absolute",top:14,right:14,background:"rgba(212,168,83,0.95)",color:C.white,padding:"5px 12px",borderRadius:7,fontSize:11,fontWeight:700,display:"flex",alignItems:"center",gap:4}}>{I.star} Featured</div>}
        </div>
        ...
        <div style={{marginBottom:24}}>
          ...
          <div style={{fontSize:14,color:C.g500,marginTop:2}}>{p.city||p.county}, {p.county} County, {p.state}</div>
        </div>

        {/* Stats Row */}
        <div style={{display:"flex",gap:0,marginBottom:28,borderRadius:12,overflow:"hidden",border:`1px solid ${C.g200}`}}>
          {[
            {icon:I.bed,val:p.beds,label:"Bedrooms"},
            {icon:I.bath,val:p.baths,label:"Bathrooms"},
            {icon:I.area,val:p.sqft?.toLocaleString(),label:"Sq Ft"},
            {icon:I.anchor,val:`${p.waterFrontage||0} ft`,label:"Water Frontage"},
            {icon:I.ruler,val:`${p.lotAcres||0} ac`,label:"Lot Size"},
            {icon:I.cal,val:p.yearBuilt||"—",label:"Year Built"},
          ].map((s,i)=>(
            <div key={i} style={{flex:1,padding:"16px 12px",background:C.white,textAlign:"center",borderRight:i<5?`1px solid ${C.g200}`:"none"}}>
              ...
              <div style={{fontSize:10,color:C.g500,fontWeight:600,letterSpacing:"0.04em",marginTop:2}}>{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{background:C.white,borderRadius:14,padding:"24px 28px",border:`1px solid ${C.g200}`,marginBottom:24}}>
          ...
          <p style={{fontSize:15,lineHeight:1.8,color:C.g700}}>{p.description}</p>
          {p.features&&p.features.length>0&&(
            <div style={{marginTop:20}}>
              <div style={{fontSize:12,fontWeight:700,color:C.g500,letterSpacing:"0.06em",marginBottom:10}}>PROPERTY FEATURES</div>
              <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
                {p.features.map((f,i)=>(
                  <span key={i} style={{padding:"6px 14px",background:C.oceanPale,borderRadius:8,fontSize:13,color:C.ocean,fontWeight:500,border:`1px solid ${C.oceanLight}33`}}>{f}</span>
                ))}
              </div>
            </div>
          )}
        ...
        <div style={{background:`linear-gradient(135deg, ${C.navy} 0%, ${C.ocean} 100%)`,borderRadius:14,padding:"24px 28px",marginBottom:24,color:C.white}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
            {I.anchor}
            <span style={{fontSize:16,fontWeight:700,fontFamily:"'Playfair Display',serif"}}>Waterfront Details</span>
          </div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:16}}>
            <div>
              <div style={{fontSize:11,opacity:0.7,fontWeight:600,letterSpacing:"0.05em"}}>TYPE</div>
              <div style={{fontSize:18,fontWeight:700,marginTop:2}}>{p.waterType}</div>
            </div>
            <div>
              <div style={{fontSize:11,opacity:0.7,fontWeight:600,letterSpacing:"0.05em"}}>FRONTAGE</div>
              <div style={{fontSize:18,fontWeight:700,marginTop:2}}>{p.waterFrontage||0} ft</div>
            </div>
            <div>
              <div style={{fontSize:11,opacity:0.7,fontWeight:600,letterSpacing:"0.05em"}}>PROPERTY ID</div>
              <div style={{fontSize:14,fontWeight:600,marginTop:4,opacity:0.8}}>{p.id}</div>
            </div>
          </div>
        </div>

        {/* Ad placeholder - future monetization */}
        <div style={{background:C.g100,borderRadius:12,padding:"20px",marginBottom:28,textAlign:"center",border:`1px dashed ${C.g300}`}}>
          <div style={{fontSize:11,color:C.g400,fontWeight:600,letterSpacing:"0.08em"}}>ADVERTISEMENT SPACE</div>
        </div>

        {/* Property Location Info */}
        <div style={{background:C.white,borderRadius:14,padding:"24px 28px",border:`1px solid ${C.g200}`,marginBottom:28}}>
          <h2 style={{fontSize:18,fontWeight:700,color:C.navy,fontFamily:"'Playfair Display',serif",marginBottom:14}}>Location</h2>
          <div style={{display:"flex",gap:20,flexWrap:"wrap"}}>
            <div style={{flex:1,minWidth:200}}>
              <div style={{fontSize:12,fontWeight:600,color:C.g500,marginBottom:4}}>ADDRESS</div>
              <div style={{fontSize:15,color:C.g800,fontWeight:500}}>{p.address}</div>
              <div style={{fontSize:14,color:C.g600,marginTop:2}}>{p.city||p.county}, {p.state}</div>
            </div>
            <div>
              <div style={{fontSize:12,fontWeight:600,color:C.g500,marginBottom:4}}>COUNTY</div>
              <div style={{fontSize:15,color:C.g800,fontWeight:500}}>{p.county}</div>
            </div>
            <div>
              <div style={{fontSize:12,fontWeight:600,color:C.g500,marginBottom:4}}>LISTED</div>
              <div style={{fontSize:15,color:C.g800,fontWeight:500}}>{p.daysOnMarket} days ago</div>
            </div>
          </div>
        </div>
...
// ─── ADMIN PANEL (same as before, condensed) ───
function Admin({properties,setProperties,onExit}){
  const[form,setForm]=useState({address:"",city:"",state:"",county:"",price:"",beds:"",baths:"",sqft:"",lotAcres:"",waterType:"",waterFrontage:"",yearBuilt:"",description:"",image:"",features:"",featured:false});
  const[editing,setEditing]=useState(null);const fileRef=useRef(null);
  const counties=form.state?COUNTIES_BY_STATE[form.state]||[]:[];
  const u=(k,v)=>setForm(p=>({...p,[k]:v}));
  const save=()=>{
    if(!form.address||!form.state||!form.waterType||!form.price){alert("Fill: Address, State, Water Type, Price");return}
    const prop={...form,id:editing||`CL-${Date.now()}`,price:Number(form.price),beds:Number(form.beds)||0,baths:Number(form.baths)||0,sqft:Number(form.sqft)||0,lotAcres:Number(form.lotAcres)||0,waterFrontage:Number(form.waterFrontage)||0,yearBuilt:Number(form.yearBuilt)||0,daysOnMarket:1,image:form.image||"https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&h=500&fit=crop",images:form.image?[form.image]:[],features:form.features?form.features.split(",").map(f=>f.trim()).filter(Boolean):[],featured:form.featured,isDemo:false};
    if(editing)setProperties(p=>p.map(x=>x.id===editing?prop:x));else setProperties(p=>[prop,...p]);
    setForm({address:"",city:"",state:"",county:"",price:"",beds:"",baths:"",sqft:"",lotAcres:"",waterType:"",waterFrontage:"",yearBuilt:"",description:"",image:"",features:"",featured:false});setEditing(null);
  };
  const editP=p=>{setEditing(p.id);setForm({...p,price:String(p.price),beds:String(p.beds),baths:String(p.baths),sqft:String(p.sqft),lotAcres:String(p.lotAcres),waterFrontage:String(p.waterFrontage),yearBuilt:String(p.yearBuilt),features:p.features?p.features.join(", "):""})};
  const delP=id=>{if(confirm("Delete?"))setProperties(p=>p.filter(x=>x.id!==id))};
  const exportD=()=>{const d=JSON.stringify(properties.filter(p=>!p.isDemo),null,2);const b=new Blob([d],{type:"application/json"});const u=URL.createObjectURL(b);const a=document.createElement("a");a.href=u;a.download="coastlist-properties.json";a.click()};
  const importD=e=>{const f=e.target.files[0];if(!f)return;const r=new FileReader();r.onload=ev=>{try{const d=JSON.parse(ev.target.result);if(Array.isArray(d)){setProperties(p=>[...d,...p.filter(x=>x.isDemo)]);alert(`Imported ${d.length} properties!`)}}catch{alert("Invalid JSON")}};r.readAsText(f)};
  const is={padding:"9px 12px",border:`1.5px solid ${C.g300}`,borderRadius:8,fontSize:13,fontFamily:"'DM Sans',sans-serif",color:C.g800,width:"100%",outline:"none"};
  return(
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.sandLight,minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:24}}>
        <div style={{background:C.white,borderRadius:13,padding:20,border:`1px solid ${C.g200}`,marginBottom:24}}>
          <div style={{fontSize:16,fontWeight:700,color:C.navy,marginBottom:14,display:"flex",alignItems:"center",gap:7}}>{I.plus} {editing?"Edit":"Add"} Property</div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Address *</label><input placeholder="123 Oceanview Dr" value={form.address} onChange={e=>u("address",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>City</label><input placeholder="Miami Beach" value={form.city} onChange={e=>u("city",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>State *</label><DD value={form.state} options={STATES} onChange={v=>{u("state",v);u("county","")}} placeholder="Select state" icon={I.pin}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>County</label><DD value={form.county} options={counties} onChange={v=>u("county",v)} placeholder={form.state?"Select":"State first"} disabled={!form.state}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Price *</label><input type="number" placeholder="2500000" value={form.price} onChange={e=>u("price",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Water Type *</label><DD value={form.waterType} options={WATER_TYPES} onChange={v=>u("waterType",v)} placeholder="Select" icon={I.water}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Beds</label><input type="number" placeholder="4" value={form.beds} onChange={e=>u("beds",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Baths</label><input type="number" placeholder="3" value={form.baths} onChange={e=>u("baths",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Sq Ft</label><input type="number" placeholder="3200" value={form.sqft} onChange={e=>u("sqft",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Water Frontage (ft)</label><input type="number" placeholder="180" value={form.waterFrontage} onChange={e=>u("waterFrontage",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Lot Acres</label><input type="number" step="0.01" placeholder="0.82" value={form.lotAcres} onChange={e=>u("lotAcres",e.target.value)} style={is}/></div>
            <div><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Year Built</label><input type="number" placeholder="2018" value={form.yearBuilt} onChange={e=>u("yearBuilt",e.target.value)} style={is}/></div>
            <div style={{gridColumn:"1/-1"}}><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Image URL</label><input placeholder="https://images.unsplash.com/..." value={form.image} onChange={e=>u("image",e.target.value)} style={is}/></div>
            <div style={{gridColumn:"1/-1"}}><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Features (comma separated)</label><input placeholder="Private Dock, Seawall, Beach Access" value={form.features} onChange={e=>u("features",e.target.value)} style={is}/></div>
            <div style={{gridColumn:"1/-1"}}><label style={{fontSize:11,fontWeight:600,color:C.g600,display:"block",marginBottom:3}}>Description</label><textarea placeholder="Stunning waterfront estate..." value={form.description} onChange={e=>u("description",e.target.value)} rows={3} style={{...is,resize:"vertical"}}/></div>
            <div style={{display:"flex",alignItems:"center",gap:8}}><input type="checkbox" checked={form.featured} onChange={e=>u("featured",e.target.checked)} id="ft"/><label htmlFor="ft" style={{fontSize:13,color:C.g700,cursor:"pointer"}}>Featured</label></div>
          </div>
          <div style={{display:"flex",gap:10,marginTop:16}}>
            <button onClick={save} style={{display:"flex",alignItems:"center",gap:5,padding:"10px 20px",background:C.green,color:C.white,border:"none",borderRadius:9,fontSize:14,fontWeight:700,cursor:"pointer"}}>{I.check} {editing?"Update":"Add"}</button>
            {editing&&<button onClick={()=>{setEditing(null);setForm({address:"",city:"",state:"",county:"",price:"",beds:"",baths:"",sqft:"",lotAcres:"",waterType:"",waterFrontage:"",yearBuilt:"",description:"",image:"",features:"",featured:false})}} style={{padding:"10px 20px",background:C.g100,border:`1px solid ${C.g300}`,borderRadius:9,fontSize:13,fontWeight:600,cursor:"pointer",color:C.g700}}>Cancel</button>}
          </div>
        </div>
        <div style={{fontSize:15,fontWeight:700,color:C.navy,marginBottom:12}}>Properties ({properties.length})</div>
        {properties.map(p=>(
          <div key={p.id} style={{display:"flex",alignItems:"center",gap:12,padding:12,background:C.white,borderRadius:10,border:`1px solid ${C.g200}`,marginBottom:8}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              <div style={{fontSize:14,fontWeight:700,color:C.navy}}>{fmtP(p.price)}</div>
              <div style={{fontSize:12,color:C.g600,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{p.address}, {p.state}</div>
            </div>
            <div style={{padding:"3px 8px",borderRadius:5,fontSize:10,fontWeight:700,background:(WC[p.waterType]||WC.Ocean).bg,color:"#fff",letterSpacing:"0.04em",textTransform:"uppercase"}}>{p.waterType}</div>
            {p.isDemo&&<span style={{fontSize:10,color:C.g500,fontWeight:600}}>DEMO</span>}
            <button onClick={()=>editP(p)} style={{background:C.g100,border:`1px solid ${C.g300}`,borderRadius:6,padding:"5px 10px",fontSize:11,fontWeight:600,cursor:"pointer",color:C.g700}}>Edit</button>
            <button onClick={()=>delP(p.id)} style={{background:"none",border:"none",cursor:"pointer",color:C.coral,display:"flex"}}>{I.trash}</button>
          </div>
        ))}
      </div>
    </div>
...
export default function CoastList(){
  ...
  useEffect(()=>{if(typeof window!=="undefined"){if(window.location.search.includes("admin=true"))setIsAdmin(true);const s=localStorage.getItem("coastlist-props");if(s)try{setProperties(JSON.parse(s))}catch{}};},[]);
  useEffect(()=>{if(typeof window!=="undefined")localStorage.setItem("coastlist-props",JSON.stringify(properties))},[properties]);
  ...
  useEffect(()=>{if(!selState||!COUNTIES_BY_STATE[selState]?.includes(selCounty))setSelCounty("")},[selState]);
  ...
  return(
    <div style={{fontFamily:"'DM Sans',sans-serif",background:C.sandLight,minHeight:"100vh"}}>
      ...
      <style>{`
        ...
        ::-webkit-scrollbar{width:5px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:${C.g300};border-radius:10px}
      ...
      {showHero&&(
        <div style={{position:"relative",background:`linear-gradient(145deg,${C.navy} 0%,#1E3A5F 40%,${C.ocean} 100%)`,padding:"80px 40px 100px",overflow:"hidden",textAlign:"center"}}>
          <div style={{position:"absolute",bottom:0,left:0,right:0,height:180,overflow:"hidden",opacity:0.06,pointerEvents:"none"}}>
            <svg viewBox="0 0 1440 200" style={{position:"absolute",bottom:0,width:"200%",animation:"waveSlide 12s linear infinite"}}><path d="M0,100 C320,180 440,20 720,100 C1000,180 1120,20 1440,100 C1760,180 1880,20 2160,100 L2160,200 L0,200 Z" fill={C.navy}/></svg>
          </div>
      ...
      <div ref={listRef} style={{maxWidth:1400,margin:"0 auto",padding:"0 22px 40px"}}>
        <div style={{position:"sticky",top:showHero?0:58,zIndex:500,background:"rgba(245,239,230,0.95)",backdropFilter:"blur(12px)",padding:"14px 0",marginBottom:18,borderBottom:`1px solid ${C.sandDark}`}}>
          <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
            ...
            <div style={{flex:1}}/>
            {af>0&&<button onClick={()=>{setSelState("");setSelCounty("");setSelWater("");setSearch("")}} style={{display:"flex",alignItems:"center",gap:3,padding:"7px 12px",background:C.coralLight+"22",border:`1px solid ${C.coral}33`,borderRadius:7,fontSize:11,fontWeight:600,color:C.coral,cursor:"pointer"}}>Clear {af} {I.x}</button>}
          </div>
